#!/usr/bin/env python
"""
This script tests the Youngs Modulus.
...
ENDNODES = [60, 61, 63, 66, 67, 69, 72, 73, 75, 78,
            79, 81, 84, 85, 87, 90, 91, 93, 96, 97,
            99, 102, 103, 105, 108, 109, 111, 114, 116, 156,
            160, 164, 168, 172, 176, 180, 184, 188, 4310, 4311,
